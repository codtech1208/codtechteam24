...
export default function Header({ onMenuClick, title }) {
  ...
  return (
    <header className="h-16 sm:h-20 bg-white border-b border-gray-100 px-3 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs">
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-gray-400 font-normal hidden xs:block">Internal Enterprise Portal</p>
        </div>
      </div>

      <div className="flex items-center gap-2 sm:gap-4 shrink-0">
        {/* Security Badge — only on medium+ screens */}
