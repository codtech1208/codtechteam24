...
async function initDatabase() {
  try {
    ...
    try { await dbRun("ALTER TABLE projects ADD COLUMN advance_amount DOUBLE NOT NULL DEFAULT 0"); } catch (e) {}
    try { await dbRun("ALTER TABLE projects ADD COLUMN received_amount DOUBLE NOT NULL DEFAULT 0"); } catch (e) {}
